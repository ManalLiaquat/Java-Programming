...
/* 4. Write a program that prompts the user for their name, and then displays a special greeting to that person if their name is the
...
*/
 ...
 if(myName === yourName)
     alert("Nice to meet you, I am also Manal");

/* 5. Write a program to check whether the given input number is divisible by 3 or not by using Switch Case statements. Show a message 
“Number is not divisible by 3” or “Number is divisible by 3”. 
*/
 var n = +prompt("Enter a number");
 switch (n) {
     case n:
...
/* 9. Write a program that takes a calendar year in YYYY format in a variable. Check & notify the user whether it is a leap year or not. */
 var n = +prompt("Enter year to CHK wheter it is a leap year or not");
 if ( n%400 == 0)
...
*/
 var savedUsername = prompt("Enter username to sign up");
 var savedPassword = prompt("Enter password (atleast 8 characters) to signup");
 var username = prompt("Enter your username to login");
 if(username === savedUsername){
     var password = prompt("User name is CORRECT\nEnter your password to login");
...
/*  11. Write a program that adds an else statement to the following script to display “You are not Fahad” */
 var firstName = "Ali";
 if (firstName === "Fahad") 
...
/* 15. Ask the user what the current hour is. If the hour is between 6 and 9 a.m., tell the user, "Breakfast is served." If the hour is
between 11 a.m. and 1 p.m., tell the user, "Time for lunch." If the hour is between 5 and 8 p.m., tell the user, "It's dinner
time." For any other hours, tell the user, "Sorry, you'll have to wait, or go get a snack." (Hint: Store the hour in 24 hours clock
format i.e. 14 for 2pm , 15 for 3pm) 
*/
 var hour = +prompt("Enter an hour in 24 Hour clock format\ni.e. \'15\' = 3PM");
 if(hour >= 6 && hour <=9)
     alert("Breakfast is searved");
...
/*  17. Write a program that takes a character (i.e. string of length 1) and returns true if it is a vowel, false otherwise. */
 var char = prompt("Enter a character to check it is a vowel or not");
...
/*  19. Use a switch statement to rewrite the following JavaScript code. Prompt the user for the number of a month rather than setting it to 8: */
 var month = 8;
 var n = +prompt("Enter month in number");
 switch (n) {
     case 1:
         alert("January")
         break;
...
/* 20. Use a conditional (ternary) operator for this exercise: If the variable age is a value below 18, the value of the variable
voteable should be "Too young", otherwise the value of voteable should be "Old enough"
*/
 var age = +prompt("Enter your age to check whether you can voteable or not");
 if (age < 18)
     alert("You cannnot vote because you are too young");
 else
     alert("You can vote because you old enough");
